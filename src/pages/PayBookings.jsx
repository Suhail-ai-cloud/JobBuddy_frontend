...
// import { getAcceptedBookings, payBooking, confirmPayment, getUserBookings } from "../api/payment";
// import { FiCheckCircle, FiClock, FiUser, FiXCircle, FiCreditCard } from "react-icons/fi";
...
//       const payment = await payBooking({ bookingId: booking.id, amount: balanceRemaining });
...
//                     <img
//                       src={booking.worker?.profile_image || "/default-avatar.png"}
//                       alt="worker"
//                       className="worker-avatar"
//                     />
//                     <h4>
//                       <FiUser /> {booking.worker?.user?.username || "N/A"}
//                     </h4>
//                   </div>
...
//                     </p>
//                     <p>
//                       <strong>Advance Paid:</strong> {formatCurrency(advancePaid)}
//                     </p>
//                     <p>
